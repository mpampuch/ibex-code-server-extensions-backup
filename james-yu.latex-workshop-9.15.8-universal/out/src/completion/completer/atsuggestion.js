...
class AtSuggestion {
    constructor(triggerCharacter) {
        ...
        const allSuggestions = JSON.parse(fs.readFileSync(`${lw_1.lw.extensionRoot}/data/at-suggestions.json`).toString());
        this.initialize(allSuggestions);
        lw_1.lw.onConfigChange('intellisense.atSuggestion.user', () => {
            this.initialize(allSuggestions);
        });
    }
