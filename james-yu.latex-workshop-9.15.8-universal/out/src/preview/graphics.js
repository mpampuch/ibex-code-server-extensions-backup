...
exports.asMD = exports.hover = void 0;
...
exports.hover = hover;
async function asMD(filePath, opts) {
    ...
    if (/\.pdf$/i.exec(filePath)) {
        ...
        if (dataUrl !== undefined) {
            ...
            else if (!lw_1.lw.extra.snippet.state.view) {
...
function findFilePath(relPath, document) {
    ...
    for (const dirPath of lw_1.lw.completer.input.graphicsPath) {
