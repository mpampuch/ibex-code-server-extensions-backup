...
exports.hook = exports.serializer = exports.view = exports.refresh = exports.viewInWebviewPanel = exports.locate = exports.isViewing = exports.handler = exports.getViewerState = exports.getParams = void 0;
...
lw_1.lw.watcher.pdf.onChange(pdfPath => {
    if (!lw_1.lw.compile.compiling || path.relative(lw_1.lw.compile.compiledPDFPath, pdfPath) !== '') {
        refresh(pdfPath);
    }
});
...
async function locate(pdfFile, record) {
    ...
    for (const client of clientSet) {
        setTimeout(() => {
            const indicator = vscode.workspace.getConfiguration('latex-workshop').get('synctex.indicator.enabled');
