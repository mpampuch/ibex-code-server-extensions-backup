...
exports.action = exports.provider = void 0;
const vscode = __importStar(require("vscode"));
const texmathenvfinder_1 = require("../preview/math/mathpreviewlib/texmathenvfinder");
/**
...
function replaceMathDelimitersInRange(document, range, oldDelim, startDelim, endDelim) {
    ...
    if (text !== oldDelim) {
        if (oldDelim === '$$') {
            const pat = /(?<!\\)\$\$/;
            const endPos = texmathenvfinder_1.TeXMathEnvFinder.findEndPair(document, pat, endRange.start);
            if (!endPos) {
                return;
            }
