...
exports.replaceArgumentPlaceholders = exports.resolveFileGlob = exports.resolveFile = exports.getSurroundingCommandRange = exports.getLongestBalancedString = exports.trimMultiLineString = exports.stripCommentsAndVerbatim = exports.stripEnvironments = exports.stripComments = exports.stripText = exports.escapeRegExp = exports.escapeHtml = exports.sleep = void 0;
...
function resolveFileGlob(dirs, inputGlob, suffix = '.tex') {
    ...
    for (const d of dirs) {
        ...
        const paths = glob_1.glob.sync(inputFileGlob);
        if (paths.length > 0) {
            return paths;
        }
    }
